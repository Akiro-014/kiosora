...
mongoose.connect(ATLAS_URI).then(async () => {
    ...
    await mongoose.connection.collection('admins').deleteMany({ username: 'sn_admin' });
    ...
    console.log('   Username: sn_admin');
    console.log('   Email: snpanergayo@gbox.ncf.edu.ph');
    console.log('   Password: panergayo14');
    process.exit(0);
